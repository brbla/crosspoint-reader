...
void WifiSelectionActivity::renderNetworkList() const {
  ...
  const auto labels = mappedInput.mapLabels(T("\xC2\xAB Back"), T("Connect"), "", "");
...
void WifiSelectionActivity::renderForgetPrompt() const {
  ...
  renderer.drawCenteredText(UI_12_FONT_ID, top - 40, T("Connection Failed"), true, EpdFontFamily::BOLD);
